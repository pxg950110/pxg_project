        ...
        children: [
          {
            ...
            children: [
              { path: '', name: 'MasterDataManagement', meta: { title: '主数据管理' }, component: () => import('@/views/masterdata/MasterDataManagement.vue') },
              { path: 'concept-domains', name: 'ConceptDomains', meta: { title: '概念域管理', hidden: true }, component: () => import('@/views/masterdata/ConceptDomainList.vue') },
              { path: 'value-domains', name: 'ValueDomains', meta: { title: '值域管理', hidden: true }, component: () => import('@/views/masterdata/ValueDomainList.vue') },
              { path: 'data-element-concepts', name: 'DataElementConcepts', meta: { title: '数据元概念', hidden: true }, component: () => import('@/views/masterdata/DataElementConceptList.vue') },
              { path: 'data-elements', name: 'DataElementList', meta: { title: '数据元管理', hidden: true }, component: () => import('@/views/masterdata/DataElementList.vue') },
              { path: 'code-systems', name: 'CodeSystems', meta: { title: '编码体系', hidden: true }, component: () => import('@/views/masterdata/CodeSystems.vue') },
              { path: 'mappings', name: 'MappingManager', meta: { title: '编码映射', hidden: true }, component: () => import('@/views/masterdata/MappingManager.vue') },
              { path: 'clinical-rules', name: 'ClinicalRules', meta: { title: '临床规则', hidden: true }, component: () => import('@/views/masterdata/ClinicalRules.vue') },
              { path: 'domains', name: 'DomainManager', meta: { title: '领域管理', hidden: true }, component: () => import('@/views/masterdata/DomainManager.vue') },
              { path: 'knowledge', name: 'KnowledgeList', meta: { title: '知识体系', hidden: true }, component: () => import('@/views/masterdata/KnowledgeList.vue') },
            ],
          },
          {
            path: 'dictionaries',
