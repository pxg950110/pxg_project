# Task 02: TypeScript Types and Component Registry

**Files:**
- Create: `src/views/data-etl/types/etl-designer.ts`

- [ ] **Step 1: Create types directory and file**

Create `src/views/data-etl/types/etl-designer.ts` with all type definitions:
...
Expected: No errors related to `etl-designer.ts`. Other existing errors are OK.

- [ ] **Step 3: Commit**

```bash
git add src/views/data-etl/types/etl-designer.ts
git commit -m "feat(etl): add TypeScript types and component registry for visual designer"
```
